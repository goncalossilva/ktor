...
public class DuplicateApplicationPluginException(message: String) : DuplicatePluginException(message)

/**
 * Thrown when Plugin has been attempted to be installed with the same key as already installed Plugin
 */
public open class DuplicatePluginException(message: String) : Exception(message)
